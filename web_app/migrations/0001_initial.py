    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('PROCESSING', 'Processing'), ('MARKETING', 'Marketing'), ('PARTNERSHIP', 'Partnership'), ('TECHNOLOGY', 'Technology'), ('OPERATIONS', 'Operations')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('TRENDS', 'Trends'), ('CASE_STUDY', 'Case Study'), ('INFORMATICS', 'Informatics')], max_length=100)),
