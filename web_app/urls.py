...
from web_app.views import home,privacy_policy,isn_insights,isn_platform,partnership_request,\
    our_journey,isn_insight,career_opportunity,our_teams,isn_market_entry,apply_job,job_detail,subscription_view,\
...
urlpatterns = [
    ...
    path('jobs',career_opportunity,name="career_opportunity"),
